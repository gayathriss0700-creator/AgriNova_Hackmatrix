  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
        ...
        <ModuleAIAdvisor 
          moduleId="farm-map" 
          moduleName="Geospatial Surveyor AI" 
          moduleIcon="🗺️" 
          contextData={{
            result,
            error
      ...
      {/* Legend */}
      <div className="card">
        <div className="section-title">How to use this map</div>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 20 }}>
          {[
            { color: "#3b82f6", label: "Click anywhere on the map to place a pulsing scanner and analyze the location's live weather & crop viability." },
          ].map(item => (
            <div key={item.label} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13 }}>
              <div style={{ width: 12, height: 12, borderRadius: "50%", background: item.color, boxShadow: "0 0 10px rgba(59, 130, 246, 0.5)" }} />
