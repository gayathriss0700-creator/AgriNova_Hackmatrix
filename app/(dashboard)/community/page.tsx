      ...
      <div className="community-hero">
        <div className="community-hero-content">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <ModuleAIAdvisor 
              moduleId="community" 
              moduleName="Community Moderator" 
              moduleIcon="🤝" 
              contextData={{
                  ...
                  >
                    ...
                    <div className="community-question-footer">
                      ...
                      <div className="community-question-stats">
                        ...
                        {/* Answer Button */}
                        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 4, background: "#f3f4f6", padding: "4px 12px", borderRadius: 16, color: "#4b5563", fontSize: 13, fontWeight: 500, transition: "background 0.2s" }} className="hover:bg-gray-200">
                          <MessageCircle size={14} />
                          Answer
                        </div>
                      </div>
