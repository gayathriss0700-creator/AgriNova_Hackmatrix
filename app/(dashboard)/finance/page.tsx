...
const initialTransactions: Transaction[] = [
  { id: "1", type: "income", category: "Crop Sale", description: "Wheat sale – 120 quintals", amount: 72000, date: "2026-07-14" },
  { id: "2", type: "income", category: "Government Subsidy", description: "PM KISAN instalment", amount: 2000, date: "2026-07-14" },
  { id: "3", type: "income", category: "Crop Sale", description: "Vegetable – tomato 150kg", amount: 3200, date: "2026-07-13" },
  { id: "4", type: "expense", category: "Labour", description: "Harvesting labour charges", amount: 11000, date: "2026-07-12" },
  { id: "5", type: "expense", category: "Fertiliser", description: "Urea + DAP purchase", amount: 2600, date: "2026-07-10" },
  { id: "6", type: "expense", category: "Irrigation", description: "Diesel for pump", amount: 1800, date: "2026-07-09" },
  { id: "7", type: "expense", category: "Seeds", description: "Hybrid paddy seeds", amount: 1300, date: "2026-07-08" },
  { id: "8", type: "expense", category: "Pesticide", description: "Fungicide spray", amount: 900, date: "2026-07-07" },
  { id: "9", type: "expense", category: "Equipment", description: "Tractor rental", amount: 1550, date: "2026-07-06" },
];
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        <ModuleAIAdvisor 
          moduleId="finance" 
          moduleName="Farm CFO & CTO" 
          moduleIcon="💰" 
          contextData={{ 
            currency: "INR (₹)",
            totalIncome: totalIncome * 1000, 
            totalExpense: totalExpense * 1000, 
