...
const mockNews: NewsItem[] = [
  { id: "m1", title: "PM-KISAN Scheme: ₹2,000 installment released to 11 crore farmers", summary: "Union Agriculture Minister releases 12th installment of PM-KISAN, injecting liquidity into rural economy.", source: "PIB India", category: "Schemes", publishedAt: getRecentTime(2), imageUrl: null, url: "https://pmkisan.gov.in/", aiSentiment: "Bullish" },
  { id: "m2", title: "IMD predicts above-normal monsoon for 2026, La Nina conditions expected", summary: "India Meteorological Department forecasts 106% of long-period average rainfall for 2026 monsoon season.", source: "IMD India", category: "Weather", publishedAt: getRecentTime(5), imageUrl: null, url: "https://mausam.imd.gov.in/", aiSentiment: "Bullish" },
  { id: "m3", title: "Wheat MSP increased to ₹2,275 per quintal for 2026-27 season", summary: "Cabinet approves increase in Minimum Support Price for wheat by ₹150 per quintal.", source: "Ministry of Agriculture", category: "Market", publishedAt: getRecentTime(8), imageUrl: null, url: "https://agricoop.nic.in/", aiSentiment: "Bullish" },
  { id: "m4", title: "Fall Armyworm threat: ICAR issues advisory for maize farmers", summary: "ICAR releases integrated pest management guidelines as Fall Armyworm sightings reported in Karnataka and Maharashtra.", source: "ICAR India", category: "Crop Health", publishedAt: getRecentTime(12), imageUrl: null, url: "https://www.icar.org.in/", aiSentiment: "Bearish" },
  { id: "m5", title: "Kisan Rail: New routes connect Bihar to Delhi and Mumbai", summary: "Indian Railways expands Kisan Rail services with two new routes to reduce transport costs for perishable produce.", source: "Indian Railways", category: "Logistics", publishedAt: getRecentTime(18), imageUrl: null, url: "https://indianrailways.gov.in/", aiSentiment: "Bullish" },
  { id: "m6", title: "Soil Health Card Scheme: 14 crore cards distributed", summary: "Government's flagship Soil Health Card scheme reaches milestone of 14 crore cards issued to farmers.", source: "PIB India", category: "Schemes", publishedAt: getRecentTime(24), imageUrl: null, url: "https://soilhealth.dac.gov.in/", aiSentiment: "Neutral" },
  { id: "m7", title: "Cotton exports surge 35% as global demand rises", summary: "India's cotton exports witness significant growth driven by demand from Bangladesh and Vietnam.", source: "Cotton Corporation of India", category: "Market", publishedAt: getRecentTime(36), imageUrl: null, url: "https://cotcorp.gov.in/", aiSentiment: "Bullish" },
  { id: "m8", title: "Micro Irrigation Fund: ₹5,000 crore sanctioned for drip irrigation", summary: "NABARD disburses funds under Micro Irrigation Fund to states for promoting water-saving technologies.", source: "NABARD", category: "Schemes", publishedAt: getRecentTime(48), imageUrl: null, url: "https://www.nabard.org/", aiSentiment: "Bullish" },
];
...
function normalizeGNewsArticle(art: any, index: number): NewsItem {
  return {
    ...
    url: art.url || "#",
    aiSentiment: Math.random() > 0.6 ? "Bullish" : Math.random() > 0.5 ? "Bearish" : "Neutral",
  };
}
